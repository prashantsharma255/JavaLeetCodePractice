    ...
    extends JFrameval
{
  ...
  private void jbInit() throws IOException
  {
    ...
    if (! (file20.exists()))
    {
      JOptionPane.showMessageDialog(this, "This is the First time You are Using this Software.\n           Initial Password is :   Umar\nYou can Change the Password As You Like.",
                                    "Password", 1);
    ...
    border1 = BorderFactory.createCompoundBorder(BorderFactory.
        ...
        RAISED,
        Color.white, new Color(163, 186, 194), new Color(71, 109, 110),
        new Color(102, 156, 158)), BorderFactory.createEmptyBorder(3, 3, 3, 3));
  ...
  protected void processWindowEvent(WindowEvent e)
  {
    ...
    {
      JOptionPane.showMessageDialog(this, "User Abort !!!",
    ...
    extends JFrame
{
  ...
  void jButton1_actionPerformed(ActionEvent e)
  {
    ...
    if ( (theFile.toString().endsWith(ext1)) ||
        (theFile.toString().endsWith(ext2))
        || (theFile.toString().endsWith(ext3)) ||
        (theFile.toString().endsWith(ext4))
        || (theFile.toString().endsWith(ext5)) ||
        (theFile.toString().endsWith(ext6)) ||
        (theFile.toString().endsWith(ext7)))
    {
      ...
      int value = JOptionPane.showConfirmDialog(this,
                                                "Do You Want To Protect Another Folder ?",
                                                "PasswordProtection",
                                                JOptionPane.YES_NO_OPTION);
      ...
      if (value == JOptionPane.YES_OPTION)
      {
        ...
        int value2 = JOptionPane.showConfirmDialog(this,
            "Do You Want To Protect Another Folder With The Same Type Of Security ?",
    ...
    else
    {
      ...
      if (jRadioButton1.isSelected())
      {
        ...
        JOptionPane.showMessageDialog(this,
                                      "Normal Folder will Protect : " +
                                      theFile.getName(), "PasswordProtection",
                                      1);
      ...
      else if (jRadioButton3.isSelected())
      {
        ...
        JOptionPane.showMessageDialog(this, "Recycle Bin Will Protect : " +
                                      theFile.getName(), "PasswordProtection",
                                      1);
      ...
      {
        JOptionPane.showMessageDialog(this, "Printers Will Protect : " +
                                      theFile.getName(), "PasswordProtection",
                                      1);
      ...
      {
        JOptionPane.showMessageDialog(this, "Web Folders Will Protect : " +
                                      theFile.getName(), "PasswordProtection",
                                      1);
      ...
      {
        JOptionPane.showMessageDialog(this,
                                      "Scanners And Cameras Will Protect : " +
                                      theFile.getName(), "PasswordProtection",
                                      1);
      ...
      else if (jRadioButton7.isSelected())
      {
        ...
        JOptionPane.showMessageDialog(this,
                                      "InterNet ShortCut Will Protect : " +
                                      theFile.getName(), "PasswordProtection",
                                      1);
...
//      file = new File(ab + "\\Windowsx.dll");
    ...
    if (pass20 == true)
    {
      ...
      if (compare == true)
      {
        ...
        {
          JOptionPane.showMessageDialog(this,
                                        "You Must Enter Atleast One Character As Password.",
                                        "PasswordProtection", 1);
          this.setVisible(true);
        }
...
//          String aba = System.getProperty("user.dir");
    ...
    else
    {
      ...
      if (pass10 == false && pass11 == false)
      {
        JOptionPane.showMessageDialog(this, "You Must Enter Somehting.",
                                      "PasswordProtection", 1);
        this.setVisible(true);
      }
    ...
    extends JFrame
{
  ...
  {
    contentPane = (JPanel)this.getContentPane();
    border1 = new TitledBorder(BorderFactory.createMatteBorder(20, 20, 20, 20,
        new Color(242, 194, 187)), "What Do You Want To Do ?");
    border2 = BorderFactory.createCompoundBorder(BorderFactory.
                                                 createBevelBorder(BevelBorder.
        RAISED, Color.white, Color.white, new Color(109, 124, 124),
        new Color(156, 178, 178)), BorderFactory.createEmptyBorder(6, 6, 6, 6));
  ...
  void jButton1_actionPerformed(ActionEvent e)
  {
    ...
    else if (jRadioButton2.isSelected())
    {
          ...
          (theFile.toString().endsWith(ext7)))
      {
        ...
        int value = JOptionPane.showConfirmDialog(this,
                                                  "Do You Want To UnProtect Another Folder ?",
                                                  "PasswordProtection",
                                                  JOptionPane.YES_NO_OPTION);
      ...
      {
        //theFile.getName();
        JOptionPane.showMessageDialog(this, theFile.getName() +
                                      " : Is Not Protected.\nYou Can Not UnProtect It.",
                                      "PasswordProtection", 1);
    ...
    extends JFrame
{
  ...
  private void jbInit() throws Exception
  {
    ...
    border1 = BorderFactory.createCompoundBorder(BorderFactory.
                                                 createBevelBorder(BevelBorder.
        LOWERED, Color.red, Color.pink, new Color(115, 114, 105),
...
class ChangePassword_jButton1_actionAdapter
...
class ChangePassword_jButton4_actionAdapter
    implements java.awt.event.ActionListener
{
  ChangePassword adaptee;
...
class FolderProtection_jButton1_actionAdapter
    implements java.awt.event.ActionListener
{
...
class PasswordProtection_jButton3_actionAdapter
    implements java.awt.event.ActionListener
{
  PasswordProtection adaptee;

  PasswordProtection_jButton3_actionAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_jButton1_actionAdapter
    implements java.awt.event.ActionListener
{
  PasswordProtection adaptee;

  PasswordProtection_jButton1_actionAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_jButton2_actionAdapter
    implements java.awt.event.ActionListener
{
  PasswordProtection adaptee;

  PasswordProtection_jButton2_actionAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_this_keyAdapter
    extends java.awt.event.KeyAdapter
{
  PasswordProtection adaptee;

  PasswordProtection_this_keyAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_this_windowAdapter
    extends java.awt.event.WindowAdapter
{
  PasswordProtection adaptee;

  PasswordProtection_this_windowAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_jButton4_actionAdapter
    implements java.awt.event.ActionListener
{
  PasswordProtection adaptee;

  PasswordProtection_jButton4_actionAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class FolderProtection_jButton2_actionAdapter
    implements java.awt.event.ActionListener
{
  FolderProtection adaptee;
...
class PasswordProtection_jButton3_keyAdapter
    extends java.awt.event.KeyAdapter
{
  PasswordProtection adaptee;

  PasswordProtection_jButton3_keyAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_jButton1_keyAdapter
    extends java.awt.event.KeyAdapter
{
  PasswordProtection adaptee;

  PasswordProtection_jButton1_keyAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_jButton2_keyAdapter
    extends java.awt.event.KeyAdapter
{
  PasswordProtection adaptee;

  PasswordProtection_jButton2_keyAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class PasswordProtection_jButton4_keyAdapter
    extends java.awt.event.KeyAdapter
{
  PasswordProtection adaptee;

  PasswordProtection_jButton4_keyAdapter(PasswordProtection adaptee)
  {
    this.adaptee = adaptee;
  }
...
class ChangePassword_jButton1_keyAdapter
    extends java.awt.event.KeyAdapter
{
  ChangePassword adaptee;
...
class ChangePassword_jButton2_keyAdapter
    extends java.awt.event.KeyAdapter
{
  ChangePassword adaptee;
...
class ChangePassword_jButton3_keyAdapter
    extends java.awt.event.KeyAdapter
{
  ChangePassword adaptee;
...
class ChangePassword_jButton4_keyAdapter
    extends java.awt.event.KeyAdapter
{
  ChangePassword adaptee;
...
class FolderProtection_jButton1_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jButton2_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jRadioButton1_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jRadioButton2_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jRadioButton3_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jRadioButton4_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jRadioButton5_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jRadioButton6_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class FolderProtection_jRadioButton7_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FolderProtection adaptee;
...
class ChangePassword_jButton5_actionAdapter
    implements java.awt.event.ActionListener
{
  ChangePassword adaptee;
...
class ChangePassword_jButton5_keyAdapter
    extends java.awt.event.KeyAdapter
{
  ChangePassword adaptee;
...
class Protectit_jButton1_actionAdapter
    implements java.awt.event.ActionListener
{
  Protectit adaptee;
...
class Protectit_jButton2_actionAdapter
    implements java.awt.event.ActionListener
{
  Protectit adaptee;
...
class Protectit_jButton1_keyAdapter
    extends java.awt.event.KeyAdapter
{
  Protectit adaptee;
...
class Protectit_jButton2_keyAdapter
    extends java.awt.event.KeyAdapter
{
  Protectit adaptee;
...
class ChooseType_jButton1_actionAdapter
    implements java.awt.event.ActionListener
{
  ChooseType adaptee;
...
class ChooseType_jButton2_actionAdapter
    implements java.awt.event.ActionListener
{
  ChooseType adaptee;
...
class ChooseType_jButton1_keyAdapter
    extends java.awt.event.KeyAdapter
{
  ChooseType adaptee;
...
class ChooseType_jButton2_keyAdapter
    extends java.awt.event.KeyAdapter
{
  ChooseType adaptee;
...
class FileProtection_jButton1_actionAdapter
    implements java.awt.event.ActionListener
{
...
class FileProtection_jButton2_actionAdapter
    implements java.awt.event.ActionListener
{
  FileProtection adaptee;
...
class FileProtection_jButton1_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FileProtection adaptee;
...
class FileProtection_jButton2_keyAdapter
    extends java.awt.event.KeyAdapter
{
  FileProtection adaptee;
